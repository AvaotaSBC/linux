...
#define CMB_PHY_FREQ_CNT_REG_OFF		0x034
#define CMB_PHY0_FREQ_EN				0
#define CMB_PHY0_FREQ_EN_MASK			(0x1 << CMB_PHY0_FREQ_EN)
#define CMB_PHY_FREQ_CNT				16
#define CMB_PHY_FREQ_CNT_MASK			(0xffff << CMB_PHY_FREQ_CNT)

#define CMB_PHY_DBG_REG0_OFF			0x0f0
#define CMB_PHY_STA_D0					0
#define CMB_PHY_STA_D0_MASK				(0xf << CMB_PHY_STA_D0)
#define CMB_PHY_STA_D1					4
#define CMB_PHY_STA_D1_MASK				(0xf << CMB_PHY_STA_D1)
#define CMB_PHY_STA_CK0					16
#define CMB_PHY_STA_CK0_MASK			(0xf << CMB_PHY_STA_CK0)
...
#define CMB_PORT_CHANNEL_OFFSET				0x20
...
#define CMB_MIPI_RAW_EXTEND         29
#define CMB_MIPI_RAW_EXTEND_MASK    (0x1 << CMB_MIPI_RAW_EXTEND)
...
#define CMB_PORT_MIPI_CH0_INI_REG_OFF			0x0114
#define CMB_PORT_MIPI_CH0_INT_PD_REG_OFF			0x0118
#define CMB_MIPI_PH_SYNC			0
#define CMB_MIPI_PH_SYNC_MASK			(0x1 << CMB_MIPI_PH_SYNC)
#define CMB_MIPI_PF_SYNC			1
#define CMB_MIPI_PF_SYNC_MASK			(0x1 << CMB_MIPI_PF_SYNC)
#define CMB_MIPI_FRAME_START_SYNC		2
#define CMB_MIPI_FRAME_START_SYNC_MASK		(0x1 << CMB_MIPI_FRAME_START_SYNC)
#define CMB_MIPI_FRAME_END_SYNC		3
#define CMB_MIPI_FRAME_END_SYNC_MASK		(0x1 << CMB_MIPI_FRAME_END_SYNC)
#define CMB_MIPI_LINE_START_SYNC		4
#define CMB_MIPI_LINE_START_SYNC_MASK		(0x1 << CMB_MIPI_LINE_START_SYNC)
#define CMB_MIPI_LINE_END_SYNC			5
#define CMB_MIPI_LINE_END_SYNC_MASK		(0x1 << CMB_MIPI_LINE_END_SYNC)
#define CMB_MIPI_EMBED_SYNC			6
#define CMB_MIPI_EMBED_SYNC_MASK		(0x1 << CMB_MIPI_EMBED_SYNC)
#define CMB_MIPI_FRAME_SYNC_ERR			7
#define CMB_MIPI_FRAME_SYNC_ERR_MASK		(0x1 << CMB_MIPI_FRAME_SYNC_ERR)
#define CMB_MIPI_LINE_SYNC_ERR			8
#define CMB_MIPI_LINE_SYNC_ERR_MASK		(0x1 << CMB_MIPI_LINE_SYNC_ERR)
#define CMB_MIPI_ECC_WRN			9
#define CMB_MIPI_ECC_WRN_MASK			(0x1 << CMB_MIPI_ECC_WRN)
#define CMB_MIPI_ECC_ERR			10
#define CMB_MIPI_ECC_ERR_MASK			(0x1 << CMB_MIPI_ECC_ERR)
#define CMB_MIPI_CHKSUM_ERR			11
#define CMB_MIPI_CHKSUM_ERR_MASK		(0x1 << CMB_MIPI_CHKSUM_ERR)
#define CMB_MIPI_EOT_ERR			12
#define CMB_MIPI_EOT_ERR_MASK			(0x1 << CMB_MIPI_EOT_ERR)
...
#define CMB_PORT_MIPI_CUR_DT_MASK		(0x3f << CMB_PORT_MIPI_CUR_DT)
#define CMB_MIPI_CUR_VC					6
#define CMB_MIPI_CUR_VC_MASK			(0x3 << CMB_MIPI_CUR_VC)
