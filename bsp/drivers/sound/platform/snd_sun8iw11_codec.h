...
#define SUNXI_AUDIO_MAX_REG_PR	SUNXI_BIAS_CALI_SET
...
#define	ADC_DAP_EN		26
#define	ADAP_DRC_EN		25
#define	ADAP_HPF_EN		24
...
struct sunxi_codec_dap_sta {
	bool dac_drc_en;
	bool dac_hpf_en;
	bool adc_drc_en;
	bool adc_hpf_en;

	struct mutex dap_mutex;
};

struct sunxi_codec_dts {
	struct sunxi_codec_dap_sta dap_sta;

	u32 dac_vol;
	u32 adc_gain;
	u32 mic1_gain;
	u32 mic2_gain;
	u32 mic1_to_omix_gain;
	u32 mic2_to_omix_gain;
	u32 fmin_to_omix_gain;
	u32 linein_to_omix_gain;
	u32 lineinl_to_romix_gain;
	u32 lineinr_to_lomix_gain;
	u32 phoneout_gain;
	u32 hpout_gain;
