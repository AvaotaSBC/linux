...
static struct resource axp22x_ac_power_supply_resources[] = {
	DEFINE_RES_IRQ_NAMED(AXP22X_IRQ_ACIN_PLUGIN, "ACIN_PLUGIN"),
	DEFINE_RES_IRQ_NAMED(AXP22X_IRQ_ACIN_REMOVAL, "ACIN_REMOVAL"),
};

static struct resource axp22x_bat_power_supply_resources[] = {
	...
	DEFINE_RES_IRQ_NAMED(AXP22X_IRQ_BATT_TEMP_HIGH, "BATT_TEMP_HIGH"),
	DEFINE_RES_IRQ_NAMED(AXP22X_IRQ_BATT_TEMP_LOW, "BATT_TEMP_LOW"),
	DEFINE_RES_IRQ_NAMED(AXP22X_IRQ_DIE_TEMP_HIGH, "DIE_TEMP_HIGH"),
	DEFINE_RES_IRQ_NAMED(AXP22X_IRQ_LOW_PWR_LVL1, "LOW_PWR_LVL1"),
	DEFINE_RES_IRQ_NAMED(AXP22X_IRQ_LOW_PWR_LVL2, "LOW_PWR_LVL2"),
};
...
static struct resource axp22x_gpio_resources[] = {
	DEFINE_RES_IRQ_NAMED(AXP22X_IRQ_GPIO1_INPUT, "GPIO1_INPUT"),
	DEFINE_RES_IRQ_NAMED(AXP22X_IRQ_GPIO0_INPUT, "GPIO0_INPUT"),
};
...
#define AXP22X_DCDC1 "dcdc1"
#define AXP22X_DCDC2 "dcdc2"
#define AXP22X_DCDC3 "dcdc3"
#define AXP22X_DCDC4 "dcdc4"
#define AXP22X_DCDC5 "dcdc5"
#define AXP22X_RTCLDO "rtc_ldo"
#define AXP22X_ALDO1 "aldo1"
#define AXP22X_ALDO2 "aldo2"
#define AXP22X_ALDO3 "aldo3"
#define AXP22X_DLDO1 "dldo1"
#define AXP22X_DLDO2 "dldo2"
#define AXP22X_DLDO3 "dldo3"
#define AXP22X_DLDO4 "dldo4"
#define AXP22X_ELDO1 "eldo1"
#define AXP22X_ELDO2 "eldo2"
#define AXP22X_ELDO3 "eldo3"
#define AXP22X_DC5LDO "dc5ldo"
#define AXP22X_LDOIO0 "ldo_io0"
#define AXP22X_LDOIO1 "ldo_io1"
#define AXP22X_DC1SW "dc1sw"
#define AXP22X_DRIVEVBUS "drivevbus"
...
static struct mfd_cell axp22x_cells[] = {
	{
		...
		.of_compatible	= "x-powers,axp22x-usb-power-supply",
		.num_resources	= ARRAY_SIZE(axp22x_usb_power_supply_resources),
		.resources	= axp22x_usb_power_supply_resources,
	}, {
		.name		= "axp22x-ac-power-supply",
		.of_compatible	= "x-powers,axp22x-ac-power-supply",
		...
		.of_compatible	= "x-powers,axp22x-bat-power-supply",
		.num_resources	= ARRAY_SIZE(axp22x_bat_power_supply_resources),
		.resources	= axp22x_bat_power_supply_resources,
	}, {
		.name		= "axp22x-gpio",
		.of_compatible	= "x-powers,axp22x-gpio",
	...
	},
	{
		...
		.platform_data = AXP22X_DCDC1,
		.pdata_size = sizeof(AXP22X_DCDC1),
	},
	{
		.of_compatible = "xpower-vregulator,dcdc2",
		.name = "reg-virt-consumer",
		.id = PLATFORM_DEVID_AUTO,
		.platform_data = AXP22X_DCDC2,
		.pdata_size = sizeof(AXP22X_DCDC2),
	},
	{
		.of_compatible = "xpower-vregulator,dcdc3",
		.name = "reg-virt-consumer",
		.id = PLATFORM_DEVID_AUTO,
		.platform_data = AXP22X_DCDC3,
		.pdata_size = sizeof(AXP22X_DCDC3),
	},
	{
		.of_compatible = "xpower-vregulator,dcdc4",
		.name = "reg-virt-consumer",
		.id = PLATFORM_DEVID_AUTO,
		.platform_data = AXP22X_DCDC4,
		.pdata_size = sizeof(AXP22X_DCDC4),
	},
	{
		.of_compatible = "xpower-vregulator,dcdc5",
		.name = "reg-virt-consumer",
		.id = PLATFORM_DEVID_AUTO,
		.platform_data = AXP22X_DCDC5,
		.pdata_size = sizeof(AXP22X_DCDC5),
	},
	{
		.of_compatible = "xpower-vregulator,rtc_ldo",
		.name = "reg-virt-consumer",
		.id = PLATFORM_DEVID_AUTO,
		.platform_data = AXP22X_RTCLDO,
		.pdata_size = sizeof(AXP22X_RTCLDO),
	},
	{
		.of_compatible = "xpower-vregulator,aldo1",
		.name = "reg-virt-consumer",
		.id = PLATFORM_DEVID_AUTO,
		.platform_data = AXP22X_ALDO1,
		.pdata_size = sizeof(AXP22X_ALDO1),
	},
	{
		.of_compatible = "xpower-vregulator,aldo2",
		.name = "reg-virt-consumer",
		.id = PLATFORM_DEVID_AUTO,
		.platform_data = AXP22X_ALDO2,
		.pdata_size = sizeof(AXP22X_ALDO2),
	},
	{
		.of_compatible = "xpower-vregulator,aldo3",
		.name = "reg-virt-consumer",
		.id = PLATFORM_DEVID_AUTO,
		.platform_data = AXP22X_ALDO3,
		.pdata_size = sizeof(AXP22X_ALDO3),
	},
	{
		.of_compatible = "xpower-vregulator,dldo1",
		.name = "reg-virt-consumer",
		.id = PLATFORM_DEVID_AUTO,
		.platform_data = AXP22X_DLDO1,
		.pdata_size = sizeof(AXP22X_DLDO1),
	},
	{
		.of_compatible = "xpower-vregulator,dldo2",
		.name = "reg-virt-consumer",
		.id = PLATFORM_DEVID_AUTO,
		.platform_data = AXP22X_DLDO2,
		.pdata_size = sizeof(AXP22X_DLDO2),
	},
	{
		.of_compatible = "xpower-vregulator,dldo3",
		.name = "reg-virt-consumer",
		.id = PLATFORM_DEVID_AUTO,
		.platform_data = AXP22X_DLDO3,
		.pdata_size = sizeof(AXP22X_DLDO3),
	},
	{
		.of_compatible = "xpower-vregulator,dldo4",
		.name = "reg-virt-consumer",
		.id = PLATFORM_DEVID_AUTO,
		.platform_data = AXP22X_DLDO4,
		.pdata_size = sizeof(AXP22X_DLDO4),
	},
	{
		.of_compatible = "xpower-vregulator,eldo1",
		.name = "reg-virt-consumer",
		.id = PLATFORM_DEVID_AUTO,
		.platform_data = AXP22X_ELDO1,
		.pdata_size = sizeof(AXP22X_ELDO1),
	},
	{
		.of_compatible = "xpower-vregulator,eldo2",
		.name = "reg-virt-consumer",
		.id = PLATFORM_DEVID_AUTO,
		.platform_data = AXP22X_ELDO2,
		.pdata_size = sizeof(AXP22X_ELDO2),
	},
	{
		.of_compatible = "xpower-vregulator,eldo3",
		.name = "reg-virt-consumer",
		.id = PLATFORM_DEVID_AUTO,
		.platform_data = AXP22X_ELDO3,
		.pdata_size = sizeof(AXP22X_ELDO3),
	},
	{
		.of_compatible = "xpower-vregulator,dc5ldo",
		.name = "reg-virt-consumer",
		.id = PLATFORM_DEVID_AUTO,
		.platform_data = AXP22X_DC5LDO,
		.pdata_size = sizeof(AXP22X_DC5LDO),
	},
	{
		.of_compatible = "xpower-vregulator,ldo_io0",
		.name = "reg-virt-consumer",
		.id = PLATFORM_DEVID_AUTO,
		.platform_data = AXP22X_LDOIO0,
		.pdata_size = sizeof(AXP22X_LDOIO0),
	},
	{
		.of_compatible = "xpower-vregulator,ldo_io1",
		.name = "reg-virt-consumer",
		.id = PLATFORM_DEVID_AUTO,
		.platform_data = AXP22X_LDOIO1,
		.pdata_size = sizeof(AXP22X_LDOIO1),
	},
	{
		.of_compatible = "xpower-vregulator,dc1sw",
		.name = "reg-virt-consumer",
		.id = PLATFORM_DEVID_AUTO,
		.platform_data = AXP22X_DC1SW,
		.pdata_size = sizeof(AXP22X_DC1SW),
	},
	{
		.of_compatible = "xpower-vregulator,drivevbus",
		.name = "reg-virt-consumer",
		.id = PLATFORM_DEVID_AUTO,
		.platform_data = AXP22X_DRIVEVBUS,
		.pdata_size = sizeof(AXP22X_DRIVEVBUS),
	},
...
static void axp20x_dts_parse(struct axp20x_dev *axp20x)
{
	...
	if (of_property_read_u32(node, "pmu_reset", &val))
		val = 0;
	if (val) {
		regmap_update_bits(map, AXP20X_OVER_TMP, BIT(3), BIT(3));
	} else {
		regmap_update_bits(map, AXP20X_OVER_TMP, BIT(3), 0);
	}
	...
	if (of_property_read_u32(node, "pmu_irq_wakeup", &val))
		val = 0;
	if (val) {
		regmap_update_bits(map, AXP20X_OVER_TMP, BIT(7), BIT(7));
	} else {
		regmap_update_bits(map, AXP20X_OVER_TMP, BIT(7), 0);
	}
