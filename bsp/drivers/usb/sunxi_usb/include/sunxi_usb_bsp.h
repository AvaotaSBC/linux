...
#define  USBC_REG_o_PHYSTATUS	0x0424
		...
		|| IS_ENABLED(CONFIG_ARCH_SUN8IW12) \
		|| IS_ENABLED(CONFIG_ARCH_SUN8IW15) \
		|| IS_ENABLED(CONFIG_ARCH_SUN8IW8) \
		|| IS_ENABLED(CONFIG_ARCH_SUN8IW7) \
		|| IS_ENABLED(CONFIG_ARCH_SUN8IW6) \
		|| IS_ENABLED(CONFIG_ARCH_SUN8IW17) \
		|| IS_ENABLED(CONFIG_ARCH_SUN8IW18) \
		|| IS_ENABLED(CONFIG_ARCH_SUN8IW16) \
