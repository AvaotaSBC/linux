...
#define CHN_DCI_OFFSET     (0x10000)
#define CHN_FCM_OFFSET     (0x11000)
#define CHN_DI300_OFFSET   (0x14400)
#define CHN_SHARP_OFFSET   (0x06000)
#define CHN_SNR_OFFSET     (0x06400)
...
#define DISP_KSC_OFFSET    (0x02000)
#define DISP_DEBAND_OFFSET (0x07000)
#define DISP_DITHER_OFFSET (0x08000)
#define DISP_GAMMA_OFFSET  (0x09000)
#define DISP_DRC_OFFSET    (0x0b000)
...
extern void *disp_malloc(void *dev, u32 num_bytes, void *phys_addr);
extern void disp_free(void *dev, void *virt_addr, void *phys_addr, u32 num_bytes);
...
s32 de_top_mem_pool_alloc(void *dev);
...
void de_top_mem_pool_free(void *dev);
